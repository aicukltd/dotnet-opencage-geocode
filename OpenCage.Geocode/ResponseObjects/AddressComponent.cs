namespace OpenCage.Geocode
{
    ...
    public class AddressComponent
    {
        ...
        [DataMember(Name = "StateDistrict")] public string StateDistrict { get; set; }
        ...
        [DataMember(Name = "BusStop")] public string BusStop { get; set; }

        [DataMember(Name = "County")] public string County { get; set; }

        [DataMember(Name = "Road")] public string Road { get; set; }
